...
import { ForgotPasswordUseCase } from '@application/services/auth/usecases';
...
export const ForgotPasswordUseCaseProvider: Provider = {
  provide: AuthUseCaseDITokens.ForgotPassword,
