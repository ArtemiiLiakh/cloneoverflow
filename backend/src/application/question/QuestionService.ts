import {
  ...
  QuestionVoteInput,
  QuestionVoteOutput,
} from '@application/question/usecases/dtos';
import { QuestionToggleFavoriteInput, QuestionToggleFavoriteOutput } from '@application/question/usecases/toggleFavorite/dto';
