...
import { AnswerUserRepositoryOutput } from '@core/repositories/answer/dtos/answerUser/AnswerUserRepositoryOutput';
import { PrismaClient } from '@prisma/client';
import { AnswerUserMapper } from '../adapters/entityMappers/AnswerUserMapper';
import { AnswerUserWhereAdapter } from '../adapters/where/AnswerUserWhereAdapter';
