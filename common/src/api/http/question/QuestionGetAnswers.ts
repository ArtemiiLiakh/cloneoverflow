...
export class QuestionGetAnswersParams {
  @ApiProperty({
...
export class QuestionGetAnswersQuery extends PaginationOptions {
  @ApiPropertyOptional({
...
export class QuestionGetAnswersDataItem {
  @ApiProperty({
...
export class QuestionGetAnswersResponse {
  @ApiProperty({
    description: 'Answers result',
    type: [QuestionGetAnswersDataItem],
  })
